...
- Arabica generates the highest number of orders (262) and units sold (947). However, Excelsa drives the highest total revenue ($12,306) due to its superior average order value ($50.64 compared to Arabica's $44.92).  Arabica brings the quantity, while Excelsa brings the highest value.
- Robusta sells more units (878) than Excelsa and Liberica, but it brings in the lowest revenue ($9,005) because of its low average order value ($37.68). Its annual sales have also remained stagnant at around $2,400 from 2019 to 2021.
